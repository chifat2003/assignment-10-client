    ...
    <div className="min-h-screen flex items-center justify-center py-12 px-4">
      <div className="max-w-md w-full bg-white dark:bg-gray-800 rounded-lg shadow p-6">
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-3 px-4 py-2 mb-4 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-600 transition disabled:opacity-50"
        >
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            <button
              ...
              className="w-full px-4 py-2 bg-blue-600 text-white rounded hover:opacity-95 disabled:opacity-50"
            >
