...
const AllTransactions = () => {
  const { fetchAllTransactions } = useAdmin();
      ...
      <div style={{ padding: '24px', width: '100%' }}>
        ...
        {transactions.length === 0 ? (
          <div style={{ padding: '60px', textAlign: 'center', color: '#475569' }}>
            <p style={{ fontSize: '16px', fontWeight: 'bold' }}>No transactions yet</p>
            <p style={{ fontSize: '14px' }}>Transactions will appear here once users make payments</p>
          </div>
        ) : (
          <div
            style={{
                    ...
                    return (
                      ...
                      >
                        <td style={{ padding: '16px 20px', fontSize: '13px', color: '#e5e7eb', fontWeight: '600' }}>
                          {txn.stripePaymentIntentId?.substring(3, 15) || txn.id?.substring(0, 8)}
                        </td>
